...
| `autograd/functional.py` | Convolution as a matmul (im2col), and the numerically stable softmax and log-softmax. |
...
---
[← The benchmark suite](benchmarks.md) · [Home](index.md) · [Contributing →](contributing.md)
