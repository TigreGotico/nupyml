...
There are **25 tasks** across those KINDs — supervised classification and
...
completion, node classification, …), clustering and OOD/anomaly ranking,
forecasting (sine, intermittent demand, **volatility**, **multivariate**),
