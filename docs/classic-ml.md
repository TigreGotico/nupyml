...
| `feature_selection` | SelectKBest/Percentile/Fpr, VarianceThreshold, RFE, RFECV, SelectFromModel, SequentialFeatureSelector, `f_classif`, `f_regression`, `chi2`, `mutual_info_*` (advanced selectors such as Boruta, mRMR, ReliefF, and stability selection are in [Beyond scikit-learn](beyond-sklearn.md)) |
...
---
[← Getting started](getting-started.md) · [Home](index.md) · [Neural networks →](neural-networks.md)
